...
<<<<<<< HEAD
            ...
            if (converter)
            {
                if (storage.Repositorio.NotasAluno.Count == 0 || Repositorio.NotasAluno.Any(l => l.ra != saida2))
                {
                    Console.Clear();

                    Console.ForegroundColor = ConsoleColor.Blue;
                    Console.WriteLine("Nenhuma nota existente para esse RA");
                    Console.ResetColor();
                ...
                var ConsultaNota = Repositorio.NotasAluno.Where(a => a.Equals(saida2)).FirstOrDefault();
                    ...
                    foreach (NotasDoAluno a in Repositorio.NotasAluno)
                    {
                        ...
                        Console.WriteLine($"\nAluno: {a.nome} | Materia: {a.materia}\n\n1°NOTA: {a.n1.ToString("N2")} | 2°NOTA: {a.n2.ToString("N2")} | 3°NOTA: {a.n3.ToString("N2")} | 4°NOTA: {a.n4.ToString("N2")} | ");
                        Console.WriteLine($"\nMEDIA: {a.media.ToString("N2")} | SITUACÃO: {a.resultado}");
                ...
                if (ConsultaProfessor != null)
                {
                    ...
                    if (conv)
                    {
                        ...
                        if (ConsultaAluno != null)
                        {
                            ...
                            Console.WriteLine("DIGITE A 1° NOTA (Ex: 10 ou 5,5 ):");
                            ...
                            while (!converterNota3 || nota3 > 10 || nota3 < 0)
                            {
                                ...
                                n3 = Console.ReadLine();
                                nota3 = 0;
                                converterNota3 = float.TryParse(n3, out nota3);
                            }

                            Console.Clear();

                            Console.WriteLine("\nDIGITE A 4° NOTA (Ex: 10 ou 5,5 ):");
                            ...
                            while (!converterNota4 || nota4 > 10 || nota4 < 0)
                            {
                                ...
                                n4 = Console.ReadLine();
                                nota4 = 0;
                                converterNota4 = float.TryParse(n4, out nota4);
                            }
                            ...
                            if (media >= 7.00)
                            {
                                ...
                                string linha2 = ($"  {nota1.ToString("N2")}         {nota2.ToString("N2")}        {nota3.ToString("N2")}        {nota4.ToString("N2")}      {media.ToString("N2")}");
